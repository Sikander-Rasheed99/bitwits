...
//
import AzizLpHeader from "@/src/app/layout/header"
import AzizLpFooter from "@/src/app/layout/footer"
                                            ...
                                            pathname == "/bitswits-services-page-3" ? <>
                                                ...
                                                pathname == "/game-development-services" ? <>
                                                    ...
                                                    pathname == "/thankyou-pagenew" ? <>
                                                        ...
                                                        pathname == "/lp/mobile-application-development-services" ||
                                                            pathname == "/mobile-application-development-services" ||
                                                            pathname == "/android-app-development-company" ||
                                                            pathname == "/mobile-game-development-company" ||
                                                            pathname == "/ai-development-company" ||
                                                            pathname == "/blockchain-game-development-company" ||
                                                            pathname == "/cross-platform-app-development-services" ||
                                                            pathname == "/flutter-app-development" ||
                                                            pathname == "/hybrid-app-development-company" ||
                                                            pathname == "/ios-app-development-company" ||
                                                            pathname == "/nft-game-development-company" ||
                ...
                pathname == "/top-mobile-app-developers" ? '' :
                    pathname == "/top-ecommerce-app-development-company" ? '' :
                        pathname == "/lp/mobile-application-development-services" ||
                            ...
                            pathname == "/ios-app-development-company" ||
                            pathname == "/nft-game-development-company" ||
                            pathname == "/react-native-app-development" ? '' : <Skicky />
            }
            {children}
            {
                            ...
                            pathname == "/video-explainer-lp" ? <VideoFooter /> :
                                pathname == "/lp/mobile-app-development-services" ? <FooterNewLps /> :
                                    pathname == "/lp/mobile-application-development-services" ||
                                        ...
                                        pathname == "/ios-app-development-company" ||
                                        pathname == "/nft-game-development-company" ||
                                        pathname == "/react-native-app-development" ? <AzizLpFooter /> :
                                        pathname == "/meet-our-team" ? null :
